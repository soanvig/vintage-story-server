...
deploy-vps: build
  ...
  ssh vps 'podman run --stop-timeout 30 --replace -it -d --name vintage-story-server --userns=keep-id -v ~/vintage-story-server-data:/home/vintagestory/data -p 42420:42420 --restart always localhost/vintage-story-server'\